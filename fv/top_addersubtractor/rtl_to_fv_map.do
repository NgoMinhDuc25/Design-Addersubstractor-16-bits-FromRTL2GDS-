...
# Generated on: Sun Feb 15 22:01:20 +07 2026 (Sun Feb 15 15:01:20 UTC 2026)
...
set logfile fv/top_addersubtractor/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/top_addersubtractor -revised fv_map -use_rtl_names
...
add_search_path . ./libraries/lib -library -both
read_library -liberty -both \
    /home/ducnm.23ce/Documents/design_addersub/libraries/lib/max/sg13g2_stdcell_slow_1p08V_125C.lib \
    /home/ducnm.23ce/Documents/design_addersub/libraries/lib/max/sg13g2_io_slow_1p08V_3p0V_125C.lib \
    /home/ducnm.23ce/Documents/design_addersub/libraries/lib/min/sg13g2_stdcell_fast_1p32V_m40C.lib \
    /home/ducnm.23ce/Documents/design_addersub/libraries/lib/min/sg13g2_io_fast_1p32V_3p6V_m40C.lib \
    /home/ducnm.23ce/Documents/design_addersub/libraries/lib/typ/sg13g2_stdcell_typ_1p20V_25C.lib \
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k rtl/addersubtractor_top.v rtl/addersubtractor.v rtl/mux2to1.v rtl/adderk.v
elaborate_design -golden -root {top_addersubtractor} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/top_addersubtractor/fv_map.v.gz
elaborate_design -revised -root {top_addersubtractor}
...
set_analyze_option -mapping_file fv/top_addersubtractor/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.top_addersubtractor.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.top_addersubtractor.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.top_addersubtractor.rtl.fv_map.rpt
